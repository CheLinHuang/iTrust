...
<%
	pageTitle = "iTrust - Childbirth Delivery";
...
<%
			...
			if (patientID == 0L) {
				...
				<div align=center>
					...
					<br />
					<a href="/iTrust/auth/getPatientID.jsp?forward=hcp/childDelivery.jsp">Back</a>		</div>
				<%	
			}
...
<div align="left" <%=hidden %> id="apptDiv">
	<h2>Childbirth Delivery UI to be implemented</h2>
	<h4><%= StringEscapeUtils.escapeHtml("" + ( action.getName(patientID) )) %> (<a href="/iTrust/auth/getPatientID.jsp?forward=hcp-uap/childDelivery.jsp">Search for other patient</a>):</h4>
</div>
