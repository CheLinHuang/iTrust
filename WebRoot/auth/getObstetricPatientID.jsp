...
<div id="oldSearch">
    <form id="mainForm" action="getPagetObstetricPatientIDtientID.jsp" method="post">
        <table>
            <tr>
                <td><b>Patient:</b></td>
    ...
    <table>
        <tr> </tr>
        <form id="userSearchForm" action="getObstetricPatientID.jsp?forward=<%= StringEscapeUtils.escapeHtml("" + ( request.getParameter("forward") )) %>" method="post">
            <tr>
    ...
    <div id="UserSearch">
        <%
            if( (!"".equals(firstName)) || (!"".equals(lastName))){
                ...
                out.println("Searching for Obstetric patients named " + StringEscapeUtils.escapeHtml("" + firstName) + " " + StringEscapeUtils.escapeHtml("" + lastName) + "<br />");
                List<PatientBean> patients = searchAction.searchForObstetricCarePatientsWithName(firstName,lastName);
...
%>
            <form id="selectPatient<%= StringEscapeUtils.escapeHtml("" + ( String.valueOf(patients.size()) )) %>" action="getObstetricPatientID.jsp?forward=<%= StringEscapeUtils.escapeHtml("" + ( request.getParameter("forward") )) %>" method="post">
